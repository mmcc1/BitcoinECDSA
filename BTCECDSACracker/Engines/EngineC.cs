 ...
 * Engine C
 * 
 * Using RNGCryptoServiceProviderInverse for weights generation.
 * 
 * Produces byte probabilities of 0.007 in a reasonable time.
 * 
 * Test if inverting the output of RNGCryptoServiceProvider results
...
namespace BTCECDSACracker.Engines
{
    ...
    public class EngineC
    {
        ...
        private void Init()
        {
            ...
            weightsGenerator = new WeightsGeneratorRNGCSPInverse();
