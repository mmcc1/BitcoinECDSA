 ...
 * Engine B
 * 
 * Using URNGFibonacci for weights generation.
 * 
 * Produces byte probabilities of 0.0057 in a reasonable time.
 * 
 * Demonstrates that random number generation is critical.
 */
using BTCLib;
using MarxMLL2;
