 ...
 * Engine D
 * 
 * Evaluating the role of the neural network on probability.  This uses a fully
 * connected 4 layer 256 network structure.
 * 
...
{
    public class EngineD : EngineBase
    {
        ...
        {
            NeuralNetworkLayerDesign nnld1 = new NeuralNetworkLayerDesign() { LayerNumber = 0, NumberOfInputs = 20, NumberOfNetworks = 256 };
            ...
            NeuralNetworkLayerDesign nnld2 = new NeuralNetworkLayerDesign() { LayerNumber = 1, NumberOfInputs = nnld1.NumberOfNetworks, NumberOfNetworks = 256 };
            ...
            nnld1.Biases = weightsGenerator.CreateRandomWeightsPositive(nnld1.Weights.Length);  // new double[nnld1.Weights.Length]; //  //Set biases to zero.
