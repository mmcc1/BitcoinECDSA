...
namespace BTCECDSAAnalyser.Entity.Tables
{
    public class WeightStatistics
    {
        public Guid Id { get; set; }
        public string WeightsHL0 { get; set; }
        public string WeightsHL1 { get; set; }
        public string WeightsHL2 { get; set; }
        public string WeightsOL { get; set; }
